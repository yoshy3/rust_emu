...
- **Mapper Support**: Mapper 0 (NROM), Mapper 1 (MMC1), Mapper 2 (UxROM), Mapper 3 (CNROM), Mapper 4 (MMC3), Mapper 21/23/25 (VRC4), Mapper 73 (VRC3).
...
- Trigger: push a Git tag (e.g. `v0.6.1`)
